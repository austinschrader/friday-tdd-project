export class User {
  ...
  mercuryYearsLeft() {
    if (this.lifeExpectancy < this.earthAge) {
      return `youve lived ${Math.abs(this.earthAge - this.lifeExpectancy) / 0.24
        } years past your life expectancy`;
    }
  ...
  venusYearsLeft() {
    if (this.lifeExpectancy < this.earthAge) {
      return `youve lived ${Math.abs(this.earthAge - this.lifeExpectancy) / 0.62
        } years past your life expectancy`;
    }
  ...
  marsYearsLeft() {
    if (this.lifeExpectancy < this.earthAge) {
      return `youve lived ${Math.abs(this.earthAge - this.lifeExpectancy) / 1.88
        } years past your life expectancy`;
    }
  ...
  jupiterYearsLeft() {
    if (this.lifeExpectancy < this.earthAge) {
      return `youve lived ${Math.abs(this.earthAge - this.lifeExpectancy) / 11.86
        } years past your life expectancy`;
    }
